...
def create_app() -> FastAPI:
    ...
    app.include_router(admin_templates.router, prefix="/api/admin")
    app.include_router(admin_export.router, prefix="/api/admin")
    app.include_router(integrations.router, prefix="/api/admin")
    app.include_router(reports.router, prefix="/api")
    app.include_router(report_builder.router, prefix="/api")
    app.include_router(report_schedules.router, prefix="/api")
    app.include_router(public_portal.router, prefix="/api")
    app.include_router(admin_portal.router, prefix="/api/admin")
    app.include_router(marketplace.router, prefix="/api")
    app.include_router(marketplace.admin_router, prefix="/api/admin")
    app.include_router(batch_jobs.router, prefix="/api")
    app.include_router(batch_jobs.schedule_router, prefix="/api")
    app.include_router(search.router, prefix="/api")
    app.include_router(quickfill.router, prefix="/api")
    app.include_router(platform.router, prefix="/api")
    app.include_router(analytics.router, prefix="/api")
    app.include_router(retention.router, prefix="/api")
    app.include_router(digital_signatures.router, prefix="/api")
    app.include_router(digital_signatures.signer_router, prefix="/api")
